    ...
    <header className="sticky top-0 z-50 w-full bg-graydark/70 backdrop-blur-sm shadow-none">
      <nav className="flex justify-between items-center max-w-5xl mx-auto px-5 py-3">
        ...
        <ul className="flex gap-6 items-center">
          <li><NavLink to="/about" className={({isActive}) => `font-semibold px-4 py-2 rounded transition ${isActive ? 'text-pink-800 underline underline-offset-8 decoration-2' : 'text-white hover:text-pink-800/80'}`}>SobreMí</NavLink></li>
